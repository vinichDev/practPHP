...
<div class="center">
    ...
    <h1>
        <a href=".">Редактирование таблицы на PHP и JS (JavaScript)</a>
    </h1>
    <button class="btMenu">
        <a href=".">
            <img src="image/home.ico" alt="Главная" title="Перейти на главную страницу" class="btMenuImg" />
        </a>
    </button>
    <button class="btMenu">
        <a href="print.php" target="_blank">
            <img src="image/print.ico" alt="Печать" title="Напечатать страницу" class="btMenuImg" />
        </a>
    </button>

    <!-- НАЧАЛО формы для добавления -->
    <button class="btMenu" id="addView" onclick="alerted();">
        <img src="image/add.ico" alt="Добавить" title="Добавить 1 строку" class="btMenuImg" />
    </button>
    ...
    <form action="index.php" id="addForm" method="get" style="display:none;">
        ...
        <table>
            <tr>
                ...
                ?>
                <td>
                    <input type="submit" name="bt1" value="Добавить" class="bt" />
                </td>
    ...
    <table class='tView1'>
        <tr class="hedTabl">
            ...
            for ($iR = 0; $iR < Count($resultMFcols); ++$iR) {
                ...
                <td>
                <a
                    href="./index.php?order=<?php echo $resultMFcols[$iR]["Field"]; ?>" title="Сортировать по убыванию"
                ><?php echo $resultMFcols[$iR]["Field"]; ?></a>
                <?php
                if ($iR > 0) {
                    ?>
                    <a href="./index.php?delrow=<?php echo $resultMFcols[$iR]["Field"]; ?>" title="Удалить столбец">
                        <img src="image/delrow.png">
                    </a>
                    <a href="./index.php?addrow=<?php echo $resultMFcols[$iR]["Field"]; ?>" title="Добавить справа">
        ...
        for ($iC = 0; $iC < Count($resultMF); $iC++) {
            ...
            for ($iR = 0; $iR < $iCountLine; $iR++) {
                ...
                <td>
                <a
                    href="#" class="js-open-modal" data-modal="1" id="id<?php echo $iR . '_' . $resultMF[$iC][0]; ?>"
                    title="Редактировать 1 строку"
                ><?php echo $resultMF[$iC][$iR]; ?></a></td><?php
            }
            // добавить 1 строку кода для UPDATE
            ?>

            <td class='actRt' title="Отредактировать">
                <a href="#" class="js-open-modal" data-modal="1" id="id<?php echo $iR . '_' . $resultMF[$iC][0]; ?>">
                    <img src="image/edit.ico">
                </a>
            </td>
            <td class='actRt' title="Удалить">
            <a href="index.php?delid=<?php echo $resultMF[$iC][0]; ?>">
...
<div id="scrollup">
    <img src="scrollup/7.png" class="up" title="Прокрутить вверх" />
</div>
